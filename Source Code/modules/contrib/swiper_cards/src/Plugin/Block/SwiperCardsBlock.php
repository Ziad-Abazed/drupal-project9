...
class SwiperCardsBlock extends BlockBase {
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    ...
    $form['swiper_card_header'] = array(
      '#type' => 'text_format',
      '#title' => t('Swiper cards header content'),
      '#description' => t('Swiper cards header content'),
    ...
    $form['swiper_card_layout'] = array(
      '#type' => 'select',
      '#title' => t('Swiper Cards Display Layout'),
      '#options' => array(
        'layout_1' => t('Layout 1'),
        'layout_2' => t('Layout 2'),
        'layout_3' => t('Layout 3'),
      ...
      '#description' => t('Swiper Card Layout'),
      '#default_value' => $config['swiper_card_layout']??'layout_1',
    );

    $form['has_background'] = array(
      '#type' => 'checkbox',
      '#title' => t('Has Background Color'),
      '#description' => t('Swiper Cards Container has Background Color'),
      '#default_value' => $config['has_background']??'false'
    );

    $form['background_color'] = array(
      '#type' => 'color',
      '#title' => t('Swiper Cards Background Color'),
      '#description' => t('Swiper Cards Container Background Color'),
    ...
    for ($i = 0; $i < $number_of_items; $i++) {
      ...
      if($is_active_row != 'inactive') {
        ...
        '#default_value' => (isset($items[$i]->card_image)) ? [$items[$i]->card_image[0]] : NULL,
      ];

      $form['items_fieldset']['items'][$i]['card_title'] = [
        '#type' => 'textfield',
        '#title' => t('Card title'),
        '#description' => t('Card title'),
      ...
      $form['items_fieldset']['items'][$i]['weight'] = [
        ...
        '#min' => 1,
        '#max' => 120,
        '#title' => t('Swiper Card order weight'),
        '#description' => t('The weight field can be used to provide customized sorting of swiper_cards.'),
